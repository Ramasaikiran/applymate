...
export default function RefundPolicy() {
  return (
    <LegalPage title="Refund and Cancellation Policy" effectiveDate="July 4, 2026">
      ...
      <P>All payments are processed via PayU. We never store your card or bank details.</P>
      ...
      <P>Refund = (Amount Paid ÷ 30) × Remaining Days − PayU's 2% fee.</P>
      <P>Days used are billed and non-refundable. PayU's 2% fee is never refundable.</P>
      ...
      <P>Full refund minus PayU's 2% fee, if we haven't screened a single job yet.</P>

      <H3>D. Technical or Billing Errors</H3>
      <P>Full refunds for verified duplicate charges or unauthorized transactions.</P>

      <H2>4. Refund Processing</H2>
      <P>Refunds go to your original payment method via PayU. Takes 5–7 business days.</P>
